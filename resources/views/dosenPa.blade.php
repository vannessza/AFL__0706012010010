        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <form action="{{route('dosenpa.index')}}">
        ...
        <table class="table table-hover ">
            ...
            <tr>
                ...
                <td>{{$do->nik}}</td>
                <td>{{$do->nama_dosen}}</td>
                <td>{{$do->jabatan_struktural}}</td>
                <td>{{$do->bidang_keahlian}}</td>
                <td>
                        <form action="{{route('dosenpa.destroy', $do->nik)}}" method="POST">
                        <a href="{{route('dosenpa.show', $do->nik)}}"><button type="button"
                        ...
                        <a href="{{route('dosenpa.edit', $do->nik)}}"><button type="button"
